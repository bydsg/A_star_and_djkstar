...
struct Road
{
    ...
    bool ifmap = 0;
    pair<float, float> lf, rb;
};
vector<Point> opnlist_point;
vector<vector<Point>> opnlist_point_vec;
...
MAP_MSG map_msg;
vector<MAP_MSG> map_msg_jubu_vec;
...
struct DOOR_MSG{
     ...
     int ifpre;
     int ifbeh;
     pair<float,float> door_pre;
     pair<float,float> door_beh;
};
DOOR_MSG door_msg1,door_msg2,door_msg3;
vector<DOOR_MSG> door_msg_vec;
